...
public class JPanel_thuePhong extends javax.swing.JPanel implements ActionListener {
     ...
     */
    public JPanel_thuePhong(String tenPhong, NhanVien nv) throws IOException, SQLException {
        initComponents();
        this.setSize(WIDTH, HEIGHT);
        nhanVien = nv;
        loadThongTin(tenPhong);
    }

    public void loadThongTin(String tenPhong) throws IOException, SQLException {
        p_dao = new Phong_DAO();
        ...
        rd_theoNgay.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    // Chỉ tính tiền theo ngày khi lựa chọn "Theo ngày" được chọn
        ...
        rd_theoGio.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    txt_tienThuePhong.setText("0 VNĐ");
                    // Bỏ bắt sự kiện của txt_ngayTra nếu đang được tính theo ngày
                    for (PropertyChangeListener listener : txt_ngayTra.getPropertyChangeListeners()) {
                        txt_ngayTra.removePropertyChangeListener(listener);
                    }

                    // Thêm sự kiện mới cho txt_ngayTra để tính theo giờ
                    txt_ngayTra.addPropertyChangeListener(new PropertyChangeListener() {
                        @Override
                        public void propertyChange(PropertyChangeEvent evt) {
                            if ("date".equals(evt.getPropertyName())) {
                                // Tính tiền theo giờ ở đây
                            }
                        }
                    });
                }
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                if (!found) {
                    ...
                    if (dau.getSoLuong() < 0) {
                        ...
                        modelDichVu.addRow(new Object[]{dau.getMaDoAnUong(), dau.getTenDoAnUong(), soLuong, currencyFormat.format(dau.getGiaBan()), currencyFormat.format(cthd.getTongTienDichVu())});
                    }
                }
        ...
        if (e.getSource().equals(btn_Luu)) {
            ...
            try {
                ...
                hd.setKhuyenMai(km_dao.getKhuyenMaiByDate(LocalDate.now()).getLast());
    ...
    public void capNhatGia() {
        ...
        double thanhTienBanDau = tienThuePhong + tongTienDV;
    ...
    private void initComponents() {
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addContainerGap(7, Short.MAX_VALUE)
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btn_themKH, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
