...
//        FlatIntelliJLaf.setup();
    ...
    public void loadData(String maPhong) throws IOException, SQLException {
        ...
        nv = nv_dao.getNhanVienTheoTen(nv_dao.getNhanVienDangNhap());
    ...
    public ChiTietPhieuDatPhong taoChiTietPDP() throws IOException, SQLException {
        ...
        return new ChiTietPhieuDatPhong(pdp, phong, true);
    }
                ...
                if (comfirm == JOptionPane.YES_OPTION) {
                    ...
                    try {
                        ...
                        Paragraph p1 = new Paragraph(
                                "Address: Số 102-103-104-105-106 Nguyễn Huệ, phường Bến Nghé, Quận 1, Tp.HCM", font);
                        document.add(p1);
                        Paragraph p2 = new Paragraph(
                                "Phone: 0988-123-789", font);
                        document.add(p2);
                        Paragraph p3 = new Paragraph(
                                "Email: annhien.hotel@annhien.com", font);
                        document.add(p3);
                        
                        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss");
                        LocalDateTime currentDateTime = LocalDateTime.now();
                        String formattedDateTime = currentDateTime.format(formatter);
                        Paragraph p4 = new Paragraph("Ngày lập phiếu: " + formattedDateTime, font);
                        document.add(p4);
//                        Paragraph p = new Paragraph("Khách sạn: An Nhiên", font);
//                        document.add(p);
//
//                        Chunk chunk1 = new Chunk("Address: Số 102-103-104-105-106 Nguyễn Huệ, phường Bến Nghé, Quận 1, Tp.HCM", font);
//                        Chunk chunk2 = new Chunk("Phone: 0988-123-789", font);
//                        Chunk chunk3 = new Chunk("Email: annhien.hotel@annhien.com", font);
//
//                        Paragraph p1 = new Paragraph();
//                        p1.add(chunk1);
...
//                        LocalDateTime currentDateTime = LocalDateTime.now();
//                        String formattedDateTime = currentDateTime.format(formatter);
//                        Paragraph p2 = new Paragraph("Ngày lập phiếu: " + formattedDateTime, font);
//                        document.add(p2);
